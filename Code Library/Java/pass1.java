...
public class pass1 {
    public static void main(String args[]) {
        String input[][] = { { null, "START", "100", null }, { null, "MOVER", "AREG", "A" },
                { "AGAIN", "ADD", "AREG", "='2'" }, { null, "ADD", "AREG", "B" }, { "AGAIN", "ADD", "AREG", "='3'" },
                { null, "LTORG", null, null }, { "AGAIN2", "ADD", "AREG", "BREG" }, { "AGAIN2", "ADD", "AREG", "CREG" },
                { "AGAIN", "ADD", "AREG", "='2'" }, { null, "DC", "B", "3" }, { "LOOP", "DS", "A", "1" },
                { null, "END", null, null } };
    ...
    static int check(String m) {
        if (m.equals("MOBER") || m.equals("ADD")) {
            return 1;
        } else if (m.equals("DS")) {
            return 2;
        } else if (m.equals("DC")) {
